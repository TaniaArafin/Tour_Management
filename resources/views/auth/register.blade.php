<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <div class="bg-white col-4 mx-auto my-3 shadow-sm" style="border-radius: 0.5rem">
                <a class="navbar-brand" href="/">
                    <img src="{{url('/img/logo.jpg')}}" class="align-middle" alt="" width="40" height="40" loading="lazy">
                    <span class="boldText align-middle textPrimary textPrimary">VROMON</span>
                </a>
            </div>
        </x-slot>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <x-jet-input class="{{ $errors->has('contact') ? 'is-invalid' : '' }}" type="text" name="contact"
